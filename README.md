...
(Дифф с версии перед stop coding)[https://github.com/mrsndmn/lct_2024/pull/13]
...
Воспроизводимость проверил на виртуалке в облаке на ubuntu. Запишу про это демо.
...
Интересно было бы исследовать, как понижение размерности слепков
может повлять на качество задачи. Для понижения размерности можно использовать
`PCA`.

Другой вариант оптимизации -- это использование квантизации для векторных
представлений для оптимизации занимаемого места.

**Алгоритм поиска взаимствований**

Сейчас алгоритм учитывает только одонго ближайшего соседа.
Скорее всего, можно получить улучшение метрик за счет увеличения
