...
def test_get_matched_segments_empty():
    ...
    expected_matched_intervals = []
    
    assert matched_intervals == expected_matched_intervals
...
def test_get_matched_segments_full_with_impostor():
    ...
    expected_matched_intervals = [[
        Segment(file_id=query_file_id, start_second=0.0, end_second=end_second),
        Segment(file_id=target_file_id, start_second=0.0, end_second=end_second),
    ]]
